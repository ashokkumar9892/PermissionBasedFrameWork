...
namespace Example.StudentsManagement.Controllers
{
    ...
    public class AdministratorsController : Controller
    {
        ...
        [AuthorizePermission(AppPermissions.MANAGE_ADMINISTRATOR_PROFILE)]
        public async Task<ActionResult> Create([Bind(Include = "Id,Name")] Administrator administrator)
        {
        ...
        public async Task<ActionResult> Edit(int? administratorId)
        {
            if (administratorId == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        [AuthorizePermission(new string[] { AppPermissions.MANAGE_ADMINISTRATOR_PROFILE })]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name")] Administrator administrator)
        {
            if (ModelState.IsValid)
            {
        ...
        [AuthorizePermission(AppPermissions.MANAGE_ADMINISTRATOR_PROFILE)]
        public async Task<ActionResult> Delete(int? administratorId)
        {
            if (administratorId == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        [AuthorizePermission(AppPermissions.MANAGE_ADMINISTRATOR_PROFILE)]
        public async Task<ActionResult> DeleteConfirmed(int administratorId)
        {
            Administrator administrator = db.GetAll<Administrator>().FirstOrDefault(a => a.Id == administratorId);
